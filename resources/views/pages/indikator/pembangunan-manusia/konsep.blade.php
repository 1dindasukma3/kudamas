...
@section('title', 'Konsep Pembangunan Manusia')
...
<div class="konsep-content">
    ...
    <p class="mt-4">
        <strong>III. Komponen Indeks Pembangunan Manusia</strong><br>

        <strong>a. Angka Harapan Hidup (AHH)</strong> pada waktu lahir merupakan rata-rata perkiraan banyak tahun yang dapat ditempuh oleh seseorang selama hidup.
        <br><br>

        <strong>b. Angka melek huruf</strong> adalah persentase penduduk usia 25 tahun ke atas yang dapat membaca dan menulis huruf latin dan atau huruf lainnya.
        <br><br>

        <strong>c. Rata-rata lama sekolah</strong> menggambarkan jumlah tahun yang digunakan oleh penduduk usia 15 tahun ke atas dalam menjalani pendidikan formal.
        <br><br>

        <strong>d. UNDP mengukur standar hidup layak</strong> menggunakan Produk Domestik Bruto (PDB) riil yang disesuaikan, sedangkan BPS dalam menghitung standar hidup layak menggunakan rata-rata pengeluaran per kapita riil yang disesuaikan dengan formula Atkinson.
    </p>
